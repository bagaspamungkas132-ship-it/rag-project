...
skill pertama menyatakan nasabah eligible. Rentang rate guardrail sudah
tertulis langsung di dalam skill "score-and-recommend-rate" (tabel Pricing
Rules) — jangan pernah merekomendasikan rate di luar rentang itu, walau
...
## Pricing Rules (guardrail — sudah di-approve treasury, JANGAN diubah tanpa persetujuan)

| Produk | Tenor_min_bulan | Tenor_max_bulan | Rate_min | Rate_max | Saldo_min_eligible_IDR |
|---|---|---|---|---|---|
| TAKA Online | 6 | 120 | 3.50% | 4.75% | 2,000,000 |
| Deposito Online | 1 | 12 | 3.00% | 5.00% | 1,000,000 |

*(Catatan: tabel ini ditulis langsung di sini, bukan lewat file Knowledge, karena
upload knowledge source dibatasi kebijakan admin/IT organisasi. Kalau nanti
admin mengizinkan, tabel ini bisa dipindah ke Knowledge source dan baris ini
tinggal diganti jadi rujukan ke sana.)*

## Langkah
1. Cari rentang aturan untuk target_produk di tabel Pricing Rules di atas
...
- Rate_direkomendasikan TIDAK BOLEH PERNAH berada di luar Rate_min-Rate_max yang
  tercantum di tabel Pricing Rules di atas untuk produk tersebut.
